function ui_FigPropPanel(efdb, propPanel, panelSize)
    ...
    set(GraphType,'SelectedObject',getcolumn(get(GraphType,'Children')',efdb.Display.getRadioIdxs(1)));
    ...
    XaxisBG=uibuttongroup(AxisProp,...
        'Title','X-axis','Units','pixels', 'Tag', 'XaxisBG',...
    ...
    set(XaxisBG,'SelectedObject',getcolumn(get(XaxisBG,'Children')',efdb.Display.getRadioIdxs(2)));

    
    YaxisBG=uibuttongroup(AxisProp,...
        'Title','Y-axis', 'Tag', 'YaxisBG',...
        'Units','pixels',...
    ...
    set(YaxisBG,'SelectedObject',getcolumn(get(YaxisBG,'Children')',efdb.Display.getRadioIdxs(3)));
