...
uipos_graphTypeH = 100;
uipos_axisOptionH = 200;
% uipos_ax
...
set(fh,'Visible','on');
    ...
    function fh=init_gui
        ...
        %% Figure property panels    
        hMainFig = Handles.fh;
%         uipanel(Handles.fh,...
%             'Units','pixels',...
%             'Tag','FigPropPanel',...
%             'CreateFcn',@GeneralCreateFcn);
        GraphType=uibuttongroup(Handles.fh,...
            'Title','GraphType',...
            'Units','pixels',...
            'Tag','GraphTypePanel',...
            'CreateFcn',@GeneralCreateFcn);
        ...
        uicontrol(GraphType,...
            ...
            'Position',[uipos_rightPanelWidth/2 30 95,20]);
        uicontrol(GraphType,...
            'Style','Radio',...
            'String','Contour',...
            'Position',[0 0 95,20]);
        uicontrol(GraphType,...
            ...
            'Position',[uipos_rightPanelWidth/2 0 95,20]);
...
%
    ...
    function fhResizeFcn(hObject,~)
        ...
        try
            ...
            set(efdb.Handles.GateList,'Position',[guipos(3)-uipos_rightPanelWidth, uipos_graphTypeH, uipos_rightPanelWidth, guipos(4)-uipos_graphTypeH]);
            
            set(efdb.Handles.GraphTypePanel,'Position',[guipos(3)-uipos_rightPanelWidth, uipos_axisOptionH, uipos_rightPanelWidth, uipos_graphTypeH]);
            set(efdb.Handles.AxisOptionPanel,'Position',[guipos(3)-uipos_rightPanelWidth, 0, uipos_rightPanelWidth, uipos_graphTypeH]);
